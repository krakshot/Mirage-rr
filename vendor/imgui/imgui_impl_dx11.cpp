...
#ifndef IMGUI_DX11_SKIP_STATE_RESTORE
    // Backup DX state that will be modified to restore it afterwards (unfortunately this is very ugly looking and verbose. Close your eyes!)
    // When hooking into a game, define IMGUI_DX11_SKIP_STATE_RESTORE: the game may leave released/invalid COM objects bound;
    // backing them up and calling Release() in restore corrupts memory and can cause null callback crashes in the game.
...
#endif // IMGUI_DX11_SKIP_STATE_RESTORE
